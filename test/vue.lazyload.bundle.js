...
(function (global, factory) {
  ...
  function createFunctionalComponent(Ctor, propsData, data, context, children) {
    ...
    return Ctor.options.render.call(null,
  ...
  var Transition = {
    ...
    render: function render(h) {
      ...
      child.key = child.key == null || child.isStatic ? "__v" + (child.tag + this._uid) + "__" : child.key;
  ...
  function genSlot(el) {
    ...
    return children ? "_t(" + slotName + "," + children + ")" : "_t(" + slotName + ")";
  }
  ...
  function genCheckboxModel(el, value) {
    ...
    addHandler(el, 'change', "var $$a=" + value + "," + '$$el=$event.target,' + "$$c=$$el.checked?(" + trueValueBinding + "):(" + falseValueBinding + ");" + 'if(Array.isArray($$a)){' + "var $$v=" + valueBinding + "," + '$$i=_i($$a,$$v);' + "if($$c){$$i<0&&(" + value + "=$$a.concat($$v))}" + "else{$$i>-1&&(" + value + "=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}" + "}else{" + value + "=$$c}", null, true);
  }
...
var a = new Vue({
    ...
    data: {
        imgs: ['./images/1.jpg', './images/2.jpg', './images/3.jpg', './images/4.jpg', './images/5.jpg', './images/6.jpg', './images/7.jpg', './images/8.jpg']
    }
});
console.log(a);
